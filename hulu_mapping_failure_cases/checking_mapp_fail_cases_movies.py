...
class movies_mapp_fail_cases:
    ...
    def main(self,start_id,thread_name,end_id):
        ...
        self.default_param()
        inputFile="input_movies_mappFail/hulu_rovi_mapping_fail_case_preprod"
    ...
    def thread_pool(self):
        t1=Process(target=self.main,args=(1,"thread-1",92))
        t1.start()
        t2=Process(target=self.main,args=(92,"thread-2",184))
        t2.start() 
