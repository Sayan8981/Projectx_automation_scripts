...
class fox_program_duplicate_checking:
    ...
    def duplicate_checking_movies(self, movie_data, source, writer,writer_credit_match_false,thread_name): 
        ...
        print ("projectx_ids : {}, fox_mo_id: {}".format(self.px_id,self.id),"threads:",thread_name)
        if len(self.px_id) > 1:               
    ...
    def thread_pool(self):
        ...
        t1=Process(target=self.main,args=(0,"thread-1",610))
        t1.start()
...
#starting
fox_program_duplicate_checking().thread_pool()