...
CSV.open("#{run_date}Headrun_validation_Preprod.csv","w+") do |cs|
    cs << ["SM_Title", "rel_yr", "USANETWORK_SM_ID", "SM_Map_Status","Duplicate_PX_id","Blind_ID","OZ_SM_ID","Blind_Status",
...
#starting
#valid_series = ["show-bigstarlittlestar"]
