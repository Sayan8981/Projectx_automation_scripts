...
class headrun_nbc_program_duplicate_checking:
    ...
    def duplicate_checking_series(self, series_data, writer,writer_credit_match_false,thread_name): 
        ...
        if self.series_title is not None:
            ...
            print ("projectx_ids : {},headrun_nbc_se_id: {}, headrun_nbc_SM_id: {}".format(self.px_id,self.id,self.show_id),"thread_name:",thread_name)
            if len(self.px_id) > 1:
    ...
    def duplicate_checking_movies(self, movie_data, writer,writer_credit_match_false,thread_name): 
        ...
        print ("projectx_ids : {}, headrun_nbc_mo_id: {}".format(self.px_id,self.id),"threads:",thread_name)
        if len(self.px_id) > 1:               
    ...
    #TODO: to get source id of headrun_nbc                      
...
#starting
headrun_nbc_program_duplicate_checking().thread_pool()